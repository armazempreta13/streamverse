...
export function AnimeHeroPremium() {
  ...
  return (
    <div className="relative w-full h-[85vh] lg:h-[90vh] overflow-hidden bg-[#050510]">
      ...
      {items.map((item, idx) => (
        ...
        >
          <div className="absolute inset-0 w-full h-full">
            ...
            <div className="absolute inset-0 bg-gradient-to-r from-[#050510] via-[#050510]/80 to-transparent w-[70%]" />
            <div className="absolute inset-x-0 bottom-0 h-1/2 bg-gradient-to-t from-[#050510] via-[#050510]/60 to-transparent" />
            <div className="absolute inset-0 mix-blend-screen opacity-30 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[#FF3366]/20 via-transparent to-transparent" />
          </div>
        </div>
      ))}

      {/* Main Content Area */}
      <div className="absolute inset-0 z-20 flex flex-col justify-center w-full max-w-[1600px] mx-auto px-6 md:px-10">
        <div className="max-w-3xl lg:max-w-4xl mt-20">
          ...
          <div className={clsx(
            ...
            <Link href={`/tmdb/tv/${content.id}`}>
              <button className="group relative flex items-center gap-3 px-8 py-4 bg-white text-black rounded-lg font-bold overflow-hidden transition-all duration-300 hover:scale-105 hover:shadow-[0_0_30px_rgba(255,255,255,0.3)]">
                <div className="absolute inset-0 bg-gradient-to-r from-white via-white to-[#f0f0f0] opacity-0 group-hover:opacity-100 transition-opacity" />
                <Play className="size-5 fill-black z-10" />
                <span className="relative z-10 tracking-wide text-sm">Assistir Agora</span>
              </button>
            </Link>

            <button className="group flex items-center gap-2 px-6 py-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-lg text-white font-medium backdrop-blur-md transition-all duration-300">
              <Plus className="size-5 text-[#8F44FF] group-hover:rotate-90 transition-transform duration-300" />
              <span className="text-sm tracking-wide">Minha Lista</span>
            </button>

            <Link href={`/tmdb/tv/${content.id}`}>
              <button className="flex items-center justify-center size-[54px] rounded-lg bg-white/5 hover:bg-white/10 border border-white/10 backdrop-blur-md transition-all duration-300">
      ...
      <div className="absolute bottom-10 right-6 md:right-10 z-30 flex items-center gap-6">
