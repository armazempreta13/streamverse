...
export function getSecurityHeaders(): Record<string, string> {
  return {
    ...
    'Content-Security-Policy': [
      ...
      "img-src 'self' data: blob: https://image.tmdb.org https://picsum.photos https://fastly.picsum.photos https://image.pollinations.ai https://images.crazygames.com https://games.assets.gamepix.com https://api.qrserver.com https://chart.googleapis.com",
      "media-src 'self' blob:",
      "frame-src 'self' https://www.youtube.com https://youtube.com https://myembed.biz https://challenges.cloudflare.com https://html5.gamedistribution.com https://play.gamepix.com https://games.crazygames.com https://www.crazygames.com https://games.gamepix.com",
